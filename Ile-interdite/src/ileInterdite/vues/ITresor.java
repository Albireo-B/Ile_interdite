...
public class ITresor extends JLabel {
    ...
    private ImageIcon calice = new ImageIcon(new ImageIcon(path + "calice.png").getImage().getScaledInstance(imgWidth, imgHeight, Image.SCALE_SMOOTH));
    private ImageIcon zephyr = new ImageIcon(new ImageIcon(path + "zephyr.png").getImage().getScaledInstance(imgWidth, imgHeight, Image.SCALE_SMOOTH));
    private ImageIcon zephyrGrisee = new ImageIcon(new ImageIcon(path + "zephyrGrisee.png").getImage().getScaledInstance(imgWidth, imgHeight, Image.SCALE_SMOOTH));
